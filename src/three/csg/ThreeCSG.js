...
import simplexFont from './FontSet.js';
...
( function () {
  ...
  */
	...
	CSG.fromText = function ( text, parameters ) {
	...
	CSG.resultFromCompactBinary = function ( resultin ) {
	...
	CSG.resultToCompactBinary = function ( resultin ) {
	...
	CSG.toMesh = function ( csg, material ) {
		...
		var three_geometry = CSG.toGeometry( csg );
